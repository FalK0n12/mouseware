...
public class SuperCrafting {
    ...
    /** Simulates a key press + release for the given GLFW key code. */
    ...
    public static void start(Minecraft client, boolean toggleMacroForRun) {
        ...
        // Press the macro key to stop the other mod
    ...
    /** Called every tick when a container screen is open. */
    public static void handleGui(Minecraft client, AbstractContainerScreen<?> screen) {
        ...
        switch (craftingStage) {
            ...
            case 1 -> {
                // Shift-click slot 32 to maximise amount
            ...
            case 2 -> {
                // Left-click slot 32 to craft all
            ...
            case 3 -> {
                // Close GUI, advance to next item
